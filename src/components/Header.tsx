...
const Header: React.FC = () => {
  ...
  return (
    ...
    src="/logo.jpeg"
    alt="Police Logo"
    width={48} // Specify the image's original width
    height={48} // Specify the image's original height
    className="w-12 h-12"
/>
            {isLogin ? (
              <div>
              ...
              <div>
                <h1 className="text-sm sm:text-base text-white">Welcome to,</h1>
                <h2 className="text-sm sm:text-base font-bold text-white">Navi Mumbai Police App</h2>
              </div>
            )}
          </div>
