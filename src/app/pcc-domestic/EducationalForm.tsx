    ...
    <form onSubmit={handleSubmit(onSubmit)} className="mx-auto max-w-screen-lg px-4 md:px-0">
      <div className="mt-8">
        <p className="text-sm sm:text-lg mt-4">
          ...
          <span className='font-bold'>Education Form</span>
        </p>
        <hr className='mt-4' />
      </div>
      ...
      <div className="relative mb-4">
        <label htmlFor="List all the Educational Institutions" className="block text-md font-bold leading-6 text-gray-900">
          List all the Educational Institutions along with perriod of completion
        </label>
        <div className="mt-2">
          <textarea
            {...register('List all the EducationalInstitutions', { required: 'Previous employers information is required' })}
            id="previousEmployers"
            className="shadow appearance-none border w-full py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-blue-500"
          ></textarea>
          {errors.previousEmployers?.message && (
            <p className="text-red-500 text-sm">
              {typeof errors.previousEmployers.message === 'string' ? errors.previousEmployers.message : ''}
            </p>
          )}
