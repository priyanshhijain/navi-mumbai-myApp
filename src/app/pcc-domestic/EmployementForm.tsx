    ...
    <form onSubmit={handleSubmit(onSubmit)} className="mx-auto max-w-screen-lg px-4 md:px-0">
      <div className="mt-8">
        <p className="text-sm sm:text-lg mt-4">
          ...
          <span className='font-bold'>Employment Form</span>
        </p>
        <hr className='mt-4' />
      </div>
      ...
      <div className="relative mb-4">
        <label htmlFor="previousEmployers" className="block text-md font-bold leading-6 text-gray-900">
          Previous Employers
        </label>
        <div className="mt-2">
          <textarea
            {...register('previousEmployers', { required: 'Previous employers information is required' })}
