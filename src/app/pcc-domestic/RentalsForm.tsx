        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mx-auto max-w-screen-lg px-4 md:px-0">
            <div className="mt-8">
                <p className="text-sm sm:text-lg mt-4">
                    ...
                    <span className='font-bold'>Housing and Rentals Form</span>
                </p>
                <hr className='mt-4' />
            </div>
            ...
            <div className="relative mb-4">
                <label htmlFor="HousingAgency" className="block text-md font-bold leading-6 text-gray-900">
                    Name of Housing Agency/Landlord
                </label>
                <div className="mt-2">
                    <textarea
                        {...register('HousingAgency', { required: 'This field is required' })}
                        id="HousingAgency"
                        className="shadow appearance-none border w-full py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-blue-500"
                    ></textarea>
                    {errors.HousingAgency?.message && (
                        <p className="text-red-500 text-sm">
                            {typeof errors.HousingAgency.message === 'string' ? errors.HousingAgency.message : ''}
                        </p>
                    )}
            ...
            <div className="relative mb-4">
                <label htmlFor="PreviousLandlordName" className="block text-md font-bold leading-6 text-gray-900">
                    Previous Landlord Name
                </label>
                <div className="mt-2">
                    <textarea
                        {...register('PreviousLandlordName', { required: 'This field is required' })}
                        id="PreviousLandlordName"
                        className="shadow appearance-none border w-full py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-blue-500"
                    ></textarea>
                    {errors.PreviousLandlordName?.message && (
                        <p className="text-red-500 text-sm">
                            {typeof errors.PreviousLandlordName.message === 'string' ? errors.PreviousLandlordName.message : ''}
                        </p>
                    )}
            ...
            <div className="relative mb-4">
                <label htmlFor="PreviousLandlordContact" className="block text-md font-bold leading-6 text-gray-900">
                ...
                <div className="mt-2">
                    <input
                        ...
                        className="shadow appearance-none border w-full py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-blue-500"
                    />
                    {errors.PreviousLandlordContact?.message && (
                        <p className="text-red-500 text-sm">
                            {typeof errors.PreviousLandlordContact.message === 'string' ? errors.PreviousLandlordContact.message : ''}
                        </p>
                    )}
